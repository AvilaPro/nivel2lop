Algoritmo factura
	...
	//Bloque de entrada
	Mostrar "Ingrese el nombre del vendedor: " Sin saltar
	Leer cliente
	Mostrar "Ingrese el monto de las ventas: " Sin saltar
	num
	Mostrar ""
	Mostrar "Ingrese el numero de años de servicio " Sin Saltar
	Leer num
	Mostrar ""
